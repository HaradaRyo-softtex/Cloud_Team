 ...
 */
@WebServlet("/admin/item/update/confirm")
public class ItemUpdateConfirmAdminController extends HttpServlet {
	/** シリアルID */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (itemForm == null) {
			...
			request.getRequestDispatcher("/jsp/admin/item/update_confirm.jsp").forward(request, response);
		}
	}

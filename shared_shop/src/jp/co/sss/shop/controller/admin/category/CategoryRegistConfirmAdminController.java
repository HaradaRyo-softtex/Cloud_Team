...
/**
 * カテゴリ情報登録確認画面表示用コントローラ
 * 
 * @author System Shared.co.,Ltd.
 */
@WebServlet("/admin/category/regist/confirm")
public class CategoryRegistConfirmAdminController extends HttpServlet {
	/** シリアルID */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (categoryForm == null) {
			...
			request.getRequestDispatcher("/jsp/admin/category/regist_confirm.jsp").forward(request, response);
		}
	}

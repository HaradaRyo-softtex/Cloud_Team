...
/* 会員情報削除確認画面表示処理用コントローラ*/

@WebServlet("/user/delete/confirm")
public class UserDeleteConfirmController extends HttpServlet {
	/** シリアルID */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (userDetailBean == null) {
			...
			request.getRequestDispatcher("/jsp/client/user/delete_confirm.jsp").forward(request, response);
		}
	}

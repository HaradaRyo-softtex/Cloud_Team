...
<body  class="admin user_delete_comfirm">
	...
	<div class="container side_wrap">
		...
		<article class="main">
			...
			<div class="user_info_form_area">
				...
				<form action="<%=request.getContextPath()%>/admin/user/delete/complete" method="post" class="user_info_form">
					<input type="hidden" name="id" value="${userForm.id}" />
					<input type="submit" value="削除" class="send_button delete" />
				</form>

...
<head>
	...
	<title>
		<%=Constant.USER%>登録完了 | <%=Constant.SHOP_TITLE%>
	</title>
</head>
<body  class="admin user_regist_complete">
	...
	<div class="container side_wrap">
		...
		<article class="main">
			...
			<p class="complete_message">
				<%=Constant.USER+MSGConstant.MSG_REGIST_COMPLETE%>
			</p>
			<p class="complete_link">
				<a href="<%=request.getContextPath()%>/admin/user/list">
					<%=Constant.USER+MSGConstant.MSG_BACK_TO_LIST%>
				</a>
			</p>
		</article>
		</div>

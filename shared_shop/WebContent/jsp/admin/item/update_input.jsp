...
<head>
	...
	<title>
		<%=Constant.ITEM%>変更入力 | <%=Constant.SHOP_TITLE%>
	</title>
</head>
	...
	<div class="container side_wrap">
		<%@include file="/jsp/common/sidebar_admin.jsp" %>
				...
				<div class="user_info_form_area">
					...
					<form method="post" action="<%=request.getContextPath()%>/admin/item/update/input" enctype="multipart/form-data" class="user_info_form">
						<br />
						<ul class="input_list">
							<li>
								<label>

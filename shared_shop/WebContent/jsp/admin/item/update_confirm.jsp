...
<head>
	...
	<title>
		<%=Constant.ITEM%>変更確認 | <%=Constant.SHOP_TITLE%>
	</title>
</head>
<body  class="admin item_update_confirm">
	...
	<div class="container side_wrap">
		...
		<article class="main">
			...
			<div class="user_info_form_area">
				...
				<form action="<%=request.getContextPath()%>/admin/item/update/complete" method="post" class="user_info_form">
					<input type="submit" value="登録" class="send_button" />
				</form>
				<form action="<%=request.getContextPath()%>/admin/item/update/input" method="post">

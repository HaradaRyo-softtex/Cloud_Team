...
<head>
	...
	<title>
		<%=Constant.ITEM%>削除確認 | <%=Constant.SHOP_TITLE%>
	</title>
</head>
<body  class="admin item_delete_comfirm">
			...
			<div class="user_info_form_area">
				<ul class="input_list">
					...
					<li>
						...
						<span class="input_value"><c:out value="${itemDetailBean.description}"/></span>
					</li>
					<li>
						<span class="input_title">
				...
				<form action="<%=request.getContextPath()%>/admin/item/delete/complete" method="post" class="user_info_form">
					<input type="hidden" name="id" value="${itemDetailBean.id}" />
					<input type="submit" value="削除" class="delete" />
				</form>
				<form action="<%=request.getContextPath()%>/admin/item/detail">
					<input type="hidden" name="id" value="${itemDetailBean.id}" />

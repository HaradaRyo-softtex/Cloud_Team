...
<head>
	...
	<title>
		<%=Constant.CATEGORY%>変更入力 | <%=Constant.SHOP_TITLE%>
	</title>
</head>
		...
		<%@include file="/jsp/common/sidebar_admin.jsp" %>
			<article class="main">
				...
				<div class="user_info_form_area">
					...
					<form method="post" action="<%=request.getContextPath()%>/admin/category/update/input" class="user_info_form">
						<br />
						<ul class="input_list">
							<li>
								<label>
									...
									<input type="text" name="name" value="<c:out value="${categoryForm.name}"/>"/>
								</label>
							</li>
							<li>
								<label>

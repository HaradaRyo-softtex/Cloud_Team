    ...
    <div class="container side_wrap">
        ...
        <article class="main">
            ...
            <c:if test="${empty basket}">
                <p><%= MSGConstant.MSG_BASKET_LIST_NONE %></p> <!-- 商品がない場合のメッセージ -->
            </c:if>
            ...
            <c:if test="${not empty basket}">
                    ...
                    <tbody>
                        <c:forEach var="item" items="${basket}">
                            <tr>
                                ...
                                <td>
                                    <!-- 商品数量更新フォーム -->
                                    <form action="${pageContext.request.contextPath}/basket/update" method="post">
                                        <input type="number" name="quantity" value="${item.orderNum}" min="1" max="${item.stock}" />
                ...
                <div class="actions">
                    ...
                    <!-- 買い物かごを空にするボタン -->
                    <form action="${pageContext.request.contextPath}/basket/clear" method="post">

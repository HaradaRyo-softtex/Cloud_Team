...
<head>
  <!--変更確認画面 -->
	...
	<title>
		<%=Constant.USER%>変更確認 | <%=Constant.SHOP_TITLE%>
	</title>
</head>
	...
	<div class="container side_wrap">
		...
		<article class="main">
			...
			<div class="user_info_form_area">
				...
				<form method="post" action="<%=request.getContextPath()%>/user/update/complete" class="user_info_form">
					<input type="submit" value="登録" class="send_button" />
				</form>
				<form method="post" action="<%=request.getContextPath()%>/user/update/input">
